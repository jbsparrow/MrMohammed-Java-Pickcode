...
public class JProcessApplicationsB {
    ...
    private static final String JSTUDENT_STATUS_FILEB = "./OUAC.pdf"; // File to write acceptance statuses to - PDF format
    private static final String JUNIVERSITY_RESPONSE_FOLDERB = "./University Responses/"; // Folder to write university responses to - responses are written to PDF files
    ...
    public void JwriteUniversityResponsesB() throws IOException, Exception { // Write university responses to files
        for (Map.Entry<String, Integer> JentryB : this.JstudentDataAveragesB.entrySet()) { // Iterate through student averages
            ...
            if (JentryB.getValue() >= this.JcutoffB + 5) {
                // Accepted
                Joutput2B.println("We are pleased to inform you that you have been accepted into the **" + Juniversity_programB + "** program at Barr University. Your academic achievements, extracurricular involvement, and passion for computer science have impressed our admissions committee.\n\n");
                ...
                // Waitlisted
                Joutput2B.println("Thank you for your application to the **" + Juniversity_programB + "** program at Barr University. We are writing to inform you that your application has been placed on our waitlist.\n\n");
                ...
                // Alternate Offer
                Joutput2B.println("Thank you for your application to the **" + Juniversity_programB + "** program at Barr University. While we are unable to offer you a spot in this program at this time, we are pleased to extend an alternate offer for admission to the **" + Jalternate_university_programB + "** program.\n\n");
                ...
                // Rejected
                Joutput2B.println("Thank you for your application to the **" + Juniversity_programB + "** program at Barr University. After careful consideration, we regret to inform you that we are unable to offer you admission at this time.\n\n");
